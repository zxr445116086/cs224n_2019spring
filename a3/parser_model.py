...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, t):
        ...
        x = embedding_vectors.view(batch_size, -1)
        ### END YOUR CODE
        return x
    ...
    def forward(self, t):
        ...
        embedding_vectors = self.embedding_lookup(t)
        hidden_tensor = self.embed_to_hidden(embedding_vectors)
        relu_ = F.relu(hidden_tensor)
        drop_out = self.dropout(relu_)
