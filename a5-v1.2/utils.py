...
def pad_sents_char(sents, char_pad_token):
    ...
    word_padded_sent_list = [[word + [char_pad_token for _ in range(max_word_length - len(word))] if len(word) <= max_word_length else word[:max_word_length] for word in sent] for sent in sents]
    sents_padded = [sent + [[char_pad_token] * max_word_length for _ in range(max_sentence_length - len(sent))] for sent in word_padded_sent_list]
